#pragma once
// image_utils.hpp — 이미지 전처리(letterbox) 및 파일 목록 유틸 (Hailo-8)
// [의존] LetterboxMeta는 postprocess_hailo8.hpp에서 정의됨 — infer_scheduler_hailo8.cpp에서
// 이 헤더보다 postprocess_hailo8.hpp가 먼저 include 되어야 한다.
